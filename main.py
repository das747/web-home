...
def handle_dialog(res, req):
    ...
    if req['session']['new']:
        ...
        res['response']['text'] = 'Привет, я навык, который поможет вам ' \
                                  ...
                                  'Я могу управлять устройствами в доме, а так же ' \
                                  'сообщать вам информацию об их состоянии.\n' \
                                  ...
                                  'Если вы хотите узнать больше информации о навыке ' \
                                  'напишите "Помощь" или "Что ты умеешь"'
        return
    ...
    if command.lower().replace('.', '').replace('?', '').replace(',', '') in ['помощь', 'что ты умеешь']:
        ...
        if not sessionStorage[user_id]['log_in']:
            res['response']['text'] = 'Я навык помощник для управления умным домом, ' \
                                      'который вы можете добавить на сайте \n' \
                                      'http://130.193.45.133 \n' \
                                      'Добавить устройства и группы можно по этой же ссылке. \n\n' \
                                      'Чтобы вы могли пользоваться списком команд, ' \
